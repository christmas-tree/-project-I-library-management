...
public class ReportStaffController {
    ...
    private final String SQL1 = "SELECT COUNT(*) FROM staff";
    private final String SQL2 = "SELECT COUNT(*) FROM staff WHERE isAdmin=1";
    private final String SQL3 = "SELECT COUNT(*) FROM staff WHERE isAdmin=0";
    ...
    public void init(IndexController c) {
        ...
        staffCount.setText(String.valueOf(staffNumber));
        adminCount.setText(String.valueOf(getCount(SQL2)));
        noAdminCount.setText(String.valueOf(getCount(SQL3)));
        ...
        for (int i = 0; i < table1Data.size(); i++) {
            pieChartData.add(new PieChart.Data(table1Data.get(i).get(0), Double.parseDouble(table1Data.get(i).get(1)) / (double) staffNumber));
        }
